...
1. Navigate to the ["API Settings"](https://manage.sanity.io/projects/8d8id83x/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://violet-strawberry-95911.sanity.studio/.
...
Generated at `2021-10-03T07:26:00.711Z` by Stackbit version `0.3.55`.